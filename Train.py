...
t_transform = []
t_transform += [transforms.ResizeImage((640,480)),
                transforms.ToTensor(),
                transforms.RandomTransformSpace(
                ...
                transforms.IntrinsicsPoseToProjection(n_views, 4)]             
t_transforms = transforms.Compose(t_transform)
...
test_dataset = MVSDdataset(datapath = cfg.TEST.PATH, mode = "test" , transforms = t_transforms, n_views = cfg.TEST.N_VIEWS, n_scales = len(cfg.MODEL.THRESHOLDS) - 1)
